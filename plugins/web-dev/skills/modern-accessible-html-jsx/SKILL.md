...
> When using a component library (e.g. MUI), prefer its layout primitives for UI composition. These rules govern semantic document structure and ARIA hygiene — they are not a reason to avoid the component library.
